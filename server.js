...
app.post('/quiz', function(req, res){
  ...
  fs.writeFile("data/allQuizzes.json", jsonString, function ( err, data) { console.log ( 'saved to data/allQuizzes.json' ) } );
...
app.put('/quiz/:id', function (req, res) {
  ...
  var jsonString = JSON.stringify(jsonContent);
  fs.writeFile("data/allQuizzes.json", jsonString , function ( err, data) {
   console.log ( 'finished saving to data/allQuizzes.json' );
  });
...
app.delete('/quiz/:id', function (req, res) {
  ...
  var jsonString = JSON.stringify(jsonContent);
  fs.writeFile("data/allQuizzes.json", jsonString, function ( err, data ) { console.log  ( 'delete from data/allQuizzes.json' ) } );
  res.send("deleted");
});
...
app.post('/users', function(req, res){
  ...
  fs.writeFile("data/users.json", jsonString, function ( err, data) { console.log ( 'saved to data/users.json') } );
  res.send(req.body);
});
